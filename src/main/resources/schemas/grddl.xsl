  ...
  <template match="*[attribute::property or attribute::rel or attribute::rev]">
    ...
    <variable name="subject">
      <choose>
        ...
        <when
          test="ancestor::*[attribute::about or ( not(attribute::href) and ( attribute::rel or attribute::rev) )][position()=1]">
    ...
    <if test="@class">
      <variable name="expended-class"><call-template name="expand-ns"><with-param name="qname" select="@class"/></call-template></variable>
          <element name = "rs.ac.uns.ftn.model.rdf:Description">
            <attribute name="rs.ac.uns.ftn.model.rdf:about"><value-of select="$expanded-about" /></attribute>
            <element name = "rs.ac.uns.ftn.model.rdf:type">
              <attribute name="rs.ac.uns.ftn.model.rdf:resource"><value-of select="$expended-class" /></attribute>
            </element>
          </element>
      </if> -->
        ...
        <element name="rs.ac.uns.ftn.model.rdf:Description">
          <choose>
            <when test="starts-with($subject,'blank node ')">
              <attribute name="rs.ac.uns.ftn.model.rdf:nodeID">
                <value-of select="substring-after($subject,'blank node ')"/>
              </attribute>
            </when>
            <otherwise>
              <attribute name="rs.ac.uns.ftn.model.rdf:about">
          ...
          <element name="{$single-predicate}" namespace="{$predicate-ns}">
            <choose>
              ...
              <otherwise>
                <attribute name="rs.ac.uns.ftn.model.rdf:resource">
          ...
          <element name="{$single-predicate}" namespace="{$predicate-ns}">
            ...
            <choose>
              ...
              <when test="string-length($datatype)>0">
                ...
                <attribute name="rs.ac.uns.ftn.model.rdf:datatype">
