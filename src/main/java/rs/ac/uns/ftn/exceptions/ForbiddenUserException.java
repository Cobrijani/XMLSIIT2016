...
public class ForbiddenUserException extends XmlSiitApplicationException {
  /**
   ...
   * @since 1.7
   */
  public ForbiddenUserException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
