 ...
 *         &lt;element ref="{http://parlament.gov.rs/akt}tacka" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class Stav {
  ...
  @XmlElementRefs({
    ...
    @XmlElementRef(name = "tacka", namespace = "http://parlament.gov.rs/akt", type = Tacka.class, required = false)
  })
  @XmlMixed
