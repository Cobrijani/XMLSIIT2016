 ...
 *         &lt;element ref="{http://parlament.gov.rs/akt}potacka" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class Tacka {
  ...
  @XmlElementRefs({
    ...
    @XmlElementRef(name = "potacka", namespace = "http://parlament.gov.rs/akt", type = Potacka.class, required = false)
  })
  @XmlMixed
